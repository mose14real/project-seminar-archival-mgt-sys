    ...
    <div class="row mt-5">
        <div class="col-md-4 mb-3">
            <div class="card project-overview-card">
                <div class="card-body">
                    <span class="badge project-overview-badge mb-2 font-poppins">No Registered of students </span>
        ...
        <div class="col-md-4 mb-3">
            <div class="card project-overview-card">
                <div class="card-body">
                    ...
                    <button class="btn btn-block w-100 project-overview-btn font-bold">+ Add New Seminar</button>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="table-responsive">
        ...
        <tbody>
            <tr class="">
              ...
              <td>Approved</td>
              <td>
                <button class="btn btn-block edit-btn" data-bs-toggle="modal" data-bs-target="#student-data-modal"><i class="bi bi-pencil-square"></i></button>
...
<div class="projects" id="project-seminar">
  <div class="container">
    <h2 class="text-center deep-blue-color mb-5 mt-5">My projects and seminars <i class="bi bi-journal"></i></h2>
  <div class="row">
