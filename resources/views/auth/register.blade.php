  ...
  <div class="row">
    ...
    <div class="col-md-6 content-register">
      <div class="overlay pt-4">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ url('student.index') }}">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ url('student.register') }}">Register</a></li>
          </ol>
        </nav>
        <div class="">
    ...
    @if($errors->any())
      <div class="alert alert-danger">
          <strong>Whoops!</strong> There were something wrong!<br>
          <ul class="error-list">
    ...
    <div class="col-md-6 pt-4 form-register">
      ...
      <form class="mt-3" action="{{ route('student.store') }}" method="POST">
        <div class="col-12 mb-3">
          <input type="text" class="form-control" placeholder="Full Name" name="fullname" value="">
        </div>
          <div class="col-12 mb-3">
            <input type="text" class="form-control" placeholder="Matric Number" name="matric_no" value="">
          </div>
          <div class="col-12 mb-3">
            <input type="text" class="form-control" placeholder="Phone Number" name="phone_no" value="">
          </div>
          <div class="col-12 mb-3">
            <input type="text" class="form-control" placeholder="Supervisor" name="supervisor" value="">
          </div>
          <div class="col-12 mb-3">
            <input type="text" class="form-control" placeholder="Session i.e 2021/2022" name="session" value="">
          </div>
        <div class="col-12 mb-3">
        ...
        <p class="text-center">Already Have An Account?🤔  Kindly <a href="{{ url('student.login') }}">Login</a> </p>
        <p class="text-center"><a href="{{ url('student.index') }}">Back to Home Page</a> </p>
      </form>
    </div>
  </div>
</div>
